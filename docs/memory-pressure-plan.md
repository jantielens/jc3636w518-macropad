...
| 2026-01-09 | issue-14-mqtt-send-action@6381485 | jc3636w518 | Baseline batch (single-user target) | S6 (`--browser-parallel 6`) ×3 | `20260109_170528_s6`..`20260109_170642_s6` | 32792–36160 (avg 34191) | 58 | 8132052 | not fired | No panic; establishes realistic “one browser user” baseline. |
| 2026-01-09 | issue-14-mqtt-send-action@6381485 (dirty) | jc3636w518 | Move `/api/config` ArduinoJson docs off AsyncTCP stack (PSRAM-preferring allocator) | S6 (`--browser-parallel 6`) ×3 | `20260109_172148_s6`..`20260109_172311_s6` | 40036–52056 (avg 47513) | 57 | 8131028 | not fired | Internal min improved: mean +13323B; worst-case +7244B vs baseline. NOTE: 2/3 runs panicked at boot (`ipc1` canary during touch init) so rerun once boot is stable to confirm. |
| 2026-01-09 | issue-14-mqtt-send-action@fc5c791 (dirty) | jc3636w518 | Portal stack/heap pressure fixes (PSRAM-first buffers + JSON doc) | S6 (`--browser-parallel 6`) ×1 | `20260109_174115_s6` | 40280 | 57 | 8132060 | not fired | No panic. Δ`hin_min` ≈ +6089B vs baseline mean; +7488B vs baseline worst. Changes: `/api/icons/installed` JSON buffer heap/PSRAM, GitHub JSON doc heap/PSRAM, OTA download buffer heap/PSRAM. |
| 2026-01-09 | issue-14-mqtt-send-action@0b748c4 (dirty) | jc3636w518 | Reduce AsyncTCP stack size (board override) + lower default fallback | S6 (`--browser-parallel 6`) ×1 | `20260109_184116_s6` | 49776 | 57 | 8119408 | not fired | No panic. AsyncTCP watermark: `raw=6144`, `rem=4812B`. Δ`hin_min` ≈ +15585B vs baseline mean; +16984B vs baseline worst. |
