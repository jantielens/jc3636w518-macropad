...
{
  ESP_PanelLcd *lcd_local = (ESP_PanelLcd *)disp->user_data;
...
void board_display_init()
{
  ...
  // LVGL draw buffer - reduced to 16 rows to ease SPI queue pressure
  size_t lv_cache_rows = 16; // Smaller buffer = fewer SPI transactions queued
